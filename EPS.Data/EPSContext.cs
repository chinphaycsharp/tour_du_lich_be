    ...
    public partial class EPSContext : DbContext, IDataProtectionKeyContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Server=DESKTOP-MV5RJQ0;User ID=quangle;Password=123456;Database=TourDuLich;Integrated Security=false;");
            }
        }
